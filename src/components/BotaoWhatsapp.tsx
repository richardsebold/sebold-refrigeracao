...
export default function BotaoWhatsapp() {
    ...
    return (
        <div className="fixed bottom-5 right-5 z-50 flex items-center justify-center w-18 h-18 bg-[#25D366] rounded-full shadow-lg transition-all duration-300 hover:scale-110 animate-bounce hover:animate-none">
